...
(print("과일 리스트에 중에서 제일 첫번째 과일은? ", fruits[0]))

(print("과일 리스트에 중에서 제일 마지막 과일은? ", fruits[-1]))

fruits.append('두리안')
print("과일 목록 : ", fruits)

(print("과일 리스트에 가장 큰 과일은(사전식 순서)? ", max(fruits)))

(print("과일 리스트에 가장 작은 과일은(사전식 순서)? ", min(fruits)))
