'''
    ...
    설명 : 사용자로부터 시작 값과 끝 값을 입력 받아 두 수 사이의 전체 합계와 짝수의 합계, 홀수의 합계를 출력하세요.

    [문제분석]
        2개의 정수를 입력 받는다.
        두 수를 포함한 두 수 사이의 모든 수의 합계를 계산한다.
        ...
        num1 > num2 ???
                ...
                => 2. nun2부터 num1까지 1씩 증가하면서...
                => 3. 두 변수의 값을 교환한다.
                => 4. 사용자에게 첫번째 값을 작은 값, 두번쨰 값은 큰 값으로 입력하도록 가이드 준다.
...
if num1 < num2 :
    ...
    if num % 2 == 0 :       # 짝수이면
        seven_sumum = even_sum + num     # 짝수의 합계를 계산한다.
    else :      # 홀수이면
        odd_sum = odd_sum + num     # 홀수의 합계를 계산한다.
else :      # num1 > num2
...
print(f"{num1}부터 {num2}까지 전체 합 : {even_sum}")
print(f"{num1}부터 {num2}까지 전체 합 : {odd_sum}")
...
for num in range(num1, num2+1) :
        total_sum = total_sum + num
if num % 2 == 0 :       # 짝수이면
        even_sum = even_sum + num     # 짝수의 합계를 계산한다.
else :      # 홀수이면
        odd_sum = odd_sum + num     # 홀수의 합계를 계산한다.
