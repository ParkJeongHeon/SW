    ...
    [알고리즘]
        ...
        3. 계속 반복하면서
            ...
            3-3. 아니면
                ...
                3-3-2. 만약 1번 아메리카노이면
                    3-3-2-1. 총 금액 = 1500원 * 잔 수 계산한다.
                3-3-3. 아니고 만약 2번 카페 라때이면
                    3-3-3-1. 총 금액 = 2500원 * 잔 수 계산한다.
                3-3-4. 아니고 만약 3번 레몬 에이드이면
                    3-3-4-1. 총 금액 = 2000원 * 잔 수 계산한다.
        4. 만약에 총 금액이 0이면 
            4-1. 감사합니다.
        5. 아니면 
            5-1. 총 금액 출력
...
while True :
    ...
    while True :
        ...
        if choice == 0 :        # 주문 번호가 0이면 음료주문을 종료한다.
            ...
            if choice == 1 :        # 아이스 아메리카노
                total_price += 1500 * cup
            elif choice == 2  :     # 카페 라때
                total_price += 2500 * cup
            elif choice == 3 :      # 레몬 에이드
