...
phone_book1['박정헌'] = '010-1234-5678'

# 딕셔너리에 값 저장 -> 2) {key : value}
phone_book2 = {'박정헌' : '010-1234-5678', '박정헌' : '010-1234-5678'}
...
# 5명의 이름과 전화번호 저장
phone_book3 = {'사람1' : '010-1234-5678'}
phone_book3 = {'사람2' : '010-1234-5679'}
phone_book3 = {'사람3' : '010-1234-5670'}
phone_book3 = {'사람4' : '010-1234-5677'}
phone_book3 = {'사람5' : '010-1234-5676'}
...
person_dict = {'name':'박정헌', 'age':20, 'class':'1학년'}
